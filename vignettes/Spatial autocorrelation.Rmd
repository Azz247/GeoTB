...
ㅤPermutation inference for Moran’s I relies on a null hypothesis of spatial randomness, with the statistic's distribution derived either under the assumption of normality (independent normal random variates) or randomization (where each value is equally likely at any location).


<mark style = "font-size: 16px; background-color : lightblue; ">Pseudo p-value</mark>

ㅤThe reference distribution is used to calculate a pseudo p-value as 
