...
```
## Methods
ㅤTB case notifications from October 2013 to September 2023 (fiscal years 2014 to 2023) were collected from medical records at Khon Kaen Hospital. In this study, we mapped the number of TB case notifications and their prevalence using an equal interval classification method. Spatial autocorrelation techniques, including Moran’s I and Local Indicators of Spatial Association (LISA), were applied to identify global and local clustering patterns.
